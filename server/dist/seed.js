...
import { ensureTables, consultantsTable, projectsTable, assignmentsTable, } from "./db.js";
...
async function seed() {
    ...
    await ensureTables();
    // --- Consultants ---
    const consultants = loadJson("Consultant.json");
    ...
    // --- Projects ---
    const projects = loadJson("Project.json");
    ...
    // --- Assignments ---
    const assignments = loadJson("Assignment.json");
