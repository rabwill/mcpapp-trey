...
class ServiceHandler extends BaseHandler_1.default {
    ...
    async listQueuesSegment(options, context) {
        ...
        if (options.maxresults !== undefined) {
            if (options.maxresults < constants_1.LIST_QUEUE_MAXRESULTS_MIN ||
                options.maxresults > constants_1.LIST_QUEUE_MAXRESULTS_MAX) {
                throw StorageErrorFactory_1.default.getOutOfRangeQueryParameterValue(context.contextID, {
                    ...
                    MinimumAllowed: `${constants_1.LIST_QUEUE_MAXRESULTS_MIN}`,
                    MaximumAllowed: `${constants_1.LIST_QUEUE_MAXRESULTS_MAX}`
                });
            }
