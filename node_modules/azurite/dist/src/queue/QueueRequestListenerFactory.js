...
const telemetry_middleware_1 = tslib_1.__importDefault(require("./middlewares/telemetry.middleware"));
/**
...
class QueueRequestListenerFactory {
    ...
    createRequestListener() {
        ...
        // Send Telemetry data
        const telemetryMiddlewareFactory = new telemetry_middleware_1.default(constants_1.DEFAULT_QUEUE_CONTEXT_PATH);
