...
class ConfigurationBase {
    constructor(host, port, keepAliveTimeout, enableAccessLog = false, accessLogWriteStream, enableDebugLog = false, debugLogFilePath, loose = false, skipApiVersionCheck = false, cert = "", key = "", pwd = "", oauth, disableProductStyleUrl = false) {
        this.host = host;
        this.port = port;
