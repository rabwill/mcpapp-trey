...
args_1.default
    ...
    .option(["", "blobKeepAliveTimeout"], "Optional. Customize http keep alive timeout for blob", constants_1.DEFAULT_BLOB_KEEP_ALIVE_TIMEOUT)
    ...
    .option(["", "queueKeepAliveTimeout"], "Optional. Customize http keep alive timeout for queue", constants_2.DEFAULT_QUEUE_KEEP_ALIVE_TIMEOUT)
    ...
    .option(["", "tableKeepAliveTimeout"], "Optional. Customize http keep alive timeout for table", constants_3.DEFAULT_TABLE_KEEP_ALIVE_TIMEOUT)
    ...
    .option(["", "disableProductStyleUrl"], "Optional. Disable getting account name from the host of request Uri, always get account name from the first path segment of request Uri")
    .option(["", "disableTelemetry"], "Optional. Disable telemtry collection of Azurite. If not specify this parameter Azurite will collect telemetry data by default.");
