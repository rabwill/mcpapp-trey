...
if (!args_1.default.config.name) {
    args_1.default
        ...
        .option(["", "disableTelemetry"], "Optional. Disable telemetry data collection of this Azurite execution. By default, Azurite will collect telemetry data to help improve the product.");
