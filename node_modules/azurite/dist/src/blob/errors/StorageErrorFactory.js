...
class StorageErrorFactory {
    ...
    static getBlobSealed(contextID = "") {
        return new StorageError_1.default(409, "BlobIsSealed", "The specified blob is sealed, and its contents can't be modified unless the blob is re-created after a delete.", contextID);
    }
}
