...
function validateReadConditions(context, conditionalHeaders, model, isSourceBlob) {
    new ReadConditionalHeadersValidator().validate(context, new ConditionalHeadersAdapter_1.default(context, conditionalHeaders), new ConditionResourceAdapter_1.default(model), isSourceBlob);
}
...
class ReadConditionalHeadersValidator {
     ...
     * @param isSourceBlob
     */
    validate(context, conditionalHeaders, resource, isSourceBlob) {
        ...
        if (!resource.exist) {
            ...
            if (conditionalHeaders.ifTags) {
                ...
                const validateFunction = (0, QueryInterpreter_1.generateQueryBlobWithTagsWhereFunction)(context, conditionalHeaders.ifTags, againstSourceBlob ? 'x-ms-source-if-tags' : 'x-ms-if-tags');
