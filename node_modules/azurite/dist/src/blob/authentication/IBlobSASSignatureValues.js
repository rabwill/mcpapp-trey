...
function generateBlobSASSignatureWithUDK(blobSASSignatureValues, resource, accountName, udkValue) {
    if (blobSASSignatureValues.version >= "2025-07-05") {
        return generateBlobSASBlobSASSignatureWithUDK20250705(blobSASSignatureValues, resource, accountName, udkValue);
    }
...
function generateBlobSASBlobSASSignatureWithUDK20250705(blobSASSignatureValues, resource, accountName, userDelegationKeyValue) {
    if (!blobSASSignatureValues.identifier &&
        (!blobSASSignatureValues.permissions && !blobSASSignatureValues.expiryTime)) {
        throw new RangeError(
        // tslint:disable-next-line:max-line-length
