...
class SqlBlobConfiguration extends ConfigurationBase_1.default {
    constructor(host = constants_2.DEFAULT_BLOB_SERVER_HOST_NAME, port = constants_2.DEFAULT_BLOB_LISTENING_PORT, keepAliveTimeout = constants_2.DEFAULT_BLOB_KEEP_ALIVE_TIMEOUT, sqlURL, sequelizeOptions = constants_1.DEFAULT_SQL_OPTIONS, persistenceArray = constants_2.DEFAULT_BLOB_PERSISTENCE_ARRAY, enableAccessLog = constants_2.DEFAULT_ENABLE_ACCESS_LOG, accessLogWriteStream, enableDebugLog = constants_2.DEFAULT_ENABLE_DEBUG_LOG, debugLogFilePath, loose = false, skipApiVersionCheck = false, cert = "", key = "", pwd = "", oauth, disableProductStyleUrl = false) {
